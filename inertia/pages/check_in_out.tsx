...
CheckInOut.layout = (page: React.ReactNode) => (
  <Layout title="Check-in / Check-out Control" children={page} />
)
...
export default function CheckInOut() {
  ...
  const [checkOuts, setCheckOuts] = useState([
    { id: 1, name: 'Alice Johnson', accommodation: 'Community Center', room: '5' },
  ...
  return (
    <>
      <h1 className="text-2xl font-semibold mb-6">Check-in / Check-out Control</h1>
            ...
            <CardContent>
              <form onSubmit={handleCheckIn} className="space-y-4 mb-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="reservation-id" placeholder="Enter reservation ID" required />
                </div>
            ...
            <CardContent>
              <form onSubmit={handleCheckOut} className="space-y-4 mb-6">
                <div className="space-y-2">
                  ...
                  <Input id="guest-name-out" placeholder="Enter guest name" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="room-number">Room Number</Label>
                  <Input id="room-number" placeholder="Enter room number" required />
                </div>
